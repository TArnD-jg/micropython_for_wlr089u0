MicroPython 1.24 - Port for Microchip SAML21/SAMR34 (WLR089U0)
=======================================================

This is a non-official, experimental MicroPython port for the Microchip WLR089U0 module
(based on ATSAML21 / ATSAMR34 with SX127x LoRa transceiver).

**For documentation, pinouts, and build instructions, please go to:**
[**ports/saml21/README.md**](ports/saml21/README.md)
